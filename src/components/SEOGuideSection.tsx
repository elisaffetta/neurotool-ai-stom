      ...
      <div className="container-neurotool">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="card-neurotool p-5">
            ...
            <div className="bg-accent/20 rounded p-3 text-xs mb-2">
              <strong>Примеры:</strong> "Имплантация зубов цена Москва" (8,900 запросов/мес), "Сколько стоит имплант" (3,200/мес)
            </div>
          ...
          <div className="card-neurotool p-5">
            ...
            <div className="bg-accent/20 rounded p-3 text-xs mb-2">
              <strong>Примеры:</strong> "Стоматология Академический район" (1,200/мес), "Детская стоматология Москва ЦАО" (890/мес)
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <div className="text-center">
          <p className="text-body mb-4">
            <strong>Не знаете, с чего начать?</strong> Мы составим контент-план бесплатно при заказе пакета от 10 статей.
          </p>
